...
#pragma endregion
	...
	
	{
		...
		condPara.AddHook(dispTypeConditionRemove, DK_NONE, HelplessConditionRemoved);
		...
		condSleeping.AddHook(dispTypeConditionRemove, DK_NONE, HelplessConditionRemoved);
	}
